...
export default function SongCard({ song, voteCount, hasVoted, onVote, onUnvote }: SongCardProps) {
  ...
  return (
    <div
      className={`group relative bg-gradient-to-br from-gray-100 to-gray-200 dark:from-zinc-900 dark:to-black rounded-xl overflow-hidden border transition-all duration-300 ${
        isCurrentSong
          ? 'border-orange-500 shadow-lg shadow-orange-500/30'
          : 'border-gray-300 dark:border-zinc-800/50 hover:border-orange-500/50'
      }`}
    >
      ...
      {isCurrentSong && (
        <div className="absolute bottom-0 left-0 right-0 h-1 bg-gray-300 dark:bg-zinc-800/50 z-10">
          <div
            ...
            <div className="flex items-start gap-3">
              ...
              {isThisSongPlaying && (
                <div className="flex items-end gap-0.5 h-6 pt-2">
                  <div className="w-1 bg-orange-500 rounded-full animate-pulse" style={{ height: '60%', animationDelay: '0ms', animationDuration: '600ms' }} />
                  <div className="w-1 bg-orange-500 rounded-full animate-pulse" style={{ height: '90%', animationDelay: '150ms', animationDuration: '600ms' }} />
                  <div className="w-1 bg-orange-500 rounded-full animate-pulse" style={{ height: '40%', animationDelay: '300ms', animationDuration: '600ms' }} />
                  <div className="w-1 bg-orange-500 rounded-full animate-pulse" style={{ height: '80%', animationDelay: '450ms', animationDuration: '600ms' }} />
                </div>
              )}

              <div className="flex-1 min-w-0">
                <h3 className={`font-semibold text-lg truncate mb-1 transition-colors ${
                  isCurrentSong ? 'text-orange-400' : 'text-gray-900 dark:text-white'
                }`}>
                  {song.name}
                </h3>
            ...
            <div className="mt-3 flex items-center gap-2 flex-wrap">
              ...
              {song.previewUrl ? (
                ...
                <a
                  ...
                  className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-emerald-700 to-green-700 hover:from-emerald-600 hover:to-green-600 text-white rounded-lg text-sm font-medium transition-all duration-200 shadow-lg shadow-emerald-500/30"
                >
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 ${
                  hasVoted
                    ...
                    : 'bg-gray-300 dark:bg-zinc-800 text-gray-700 dark:text-gray-300 hover:bg-gray-400 dark:hover:bg-zinc-700 hover:text-gray-900 dark:hover:text-white'
                }`}
              >
                {hasVoted ? (
                  <>
